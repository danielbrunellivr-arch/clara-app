...
async function submitAuth() {
  ...
  console.log('submitAuth - authMode:', authMode, 'isNewUser:', isNewUser, 'profileHasStyle:', profileHasStyle);

  if (isNewUser || !profileHasStyle) {
    console.log('Mostro onboarding - isNewUser:', isNewUser);
    ...
    console.log('onboarding element:', onbEl);
