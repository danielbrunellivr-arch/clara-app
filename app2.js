  ...
  document.querySelectorAll('[data-exercise-id]').forEach(card => {
    ...
    if (completedExercisesCache.has(id)) {
      if (!card.querySelector('.ex-done-badge')) {
        ...
        badge.style.cssText = 'position:absolute;top:12px;right:12px;background:rgba(124,232,168,0.2);color:#085041;font-size:10px;font-weight:500;padding:2px 8px;border-radius:20px;letter-spacing:0.05em';
