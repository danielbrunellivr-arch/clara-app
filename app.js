...
async function init() {
  ...
  console.log('Init - hasSession:', hasSession, 'currentUser:', currentUser?.email);
  ...
  if (hasSession) {
    ...
    console.log('userProfile:', userProfile, 'profileDone:', profileDone);
    const state = loadState();
    ...
    // Se non ha fatto il test, l'onboarding rimane visibile
  } else {
